...
*/
    ...
    private void initNihssBars() {
        ...
        oneA.add(new NihssItemBar.ItemBean("0=正常或轻微面瘫", 0, false));
        ...
        oneB.add(new NihssItemBar.ItemBean("0=无瘫痪", 0, false));
        ...
        oneC.add(new NihssItemBar.ItemBean("0=无语言障碍", 0, false));
